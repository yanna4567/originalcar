...
: ${AMENT_CURRENT_PREFIX:="/userdata/dev_ws/install/qr_decoder"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/qr_decoder/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/qr_decoder/environment/path.sh"
